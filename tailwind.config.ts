	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-hero': 'linear-gradient(135deg, hsl(270, 60%, 15%) 0%, hsl(24, 95%, 53%) 100%)',
				'gradient-card-1': 'linear-gradient(135deg, hsl(220, 70%, 12%) 0%, hsl(220, 60%, 18%) 100%)',
				'gradient-card-2': 'linear-gradient(135deg, hsl(24, 80%, 12%) 0%, hsl(24, 70%, 18%) 100%)',
				'gradient-card-3': 'linear-gradient(135deg, hsl(160, 60%, 12%) 0%, hsl(160, 50%, 18%) 100%)',
			},
			fontFamily: {
